...
' a module for indeed.com job description web scraper'
...
def get_soup(url):
    ...
    Returns:
        soup: soup object
    """
    driver = webdriver.Chrome("C:/Users/RayHu/Downloads/chromedriver_win32/chromedriver.exe")
    driver.get(url)
...
if __name__ == "__main__":
    ...
    get_data(query, 1, location='Chicago')